...
import ImgPunchClock from '~/assets/img/clock_blue.png';
...
export const TimeClockHeader = ({ onOpenSetting }: IProps) => {
  return (
    <div className="bg-white rounded-xl shadow flex items-center justify-between">
      <div className="flex gap-4 items-center">
        <div className="flex items-center">
          <img src={ImgPunchClock} width={50} alt="punch-clock" />
        ...
        <div className="rounded-full bg-[#d7eaf9] p-2 pl-0 cursor-pointer">
          ...
          Synced with: <Link to={path.JOB_SCHEDULE}>Job Scheduler</Link>
        </div>
      </div>
